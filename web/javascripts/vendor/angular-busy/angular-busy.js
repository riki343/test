(function (angular) {
    angular
        .module('cgBusy',[])
        .factory('_cgBusyTrackerFactory', _cgBusyTrackerFactory)
    ...
    cgBusy.$inject = ['$compile','$templateCache','cgBusyDefaults','$http','_cgBusyTrackerFactory'];
    function cgBusy ($compile,$templateCache,cgBusyDefaults,$http,_cgBusyTrackerFactory) {
        "use strict";
        return {
            restrict: 'A',
    ...
    function runModule($templateCache) {
        ...
        $templateCache.put('angular-busy.html',
            ...
            "      </div>\n" +
            "\n" +
            "      <div class=\"cg-busy-default-text\" ng-bind=\"$message\"></div>\n" +
            "\n" +
            "   </div>\n" +
            "\n" +
            "</div>"
